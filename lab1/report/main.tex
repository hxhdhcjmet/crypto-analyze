...
\reportName{张三、李四、王五}
\reportID{202400460001、202400460002、202400460003}
\reportMajor{密码科学与技术}
...
\subsection{组员分工}
\begin{itemize}
    \item 张三（202400460001）：Enigma 加密程序实现与任务一测试。
    \item 李四（202400460002）：实验原理整理、密钥空间计算与任务三分析。
    \item 王五（202400460003）：实验报告撰写、结果整理与格式校对。
\end{itemize}
% 实验环境
